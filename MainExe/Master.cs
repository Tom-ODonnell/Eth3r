...
namespace Eth3r
{
    public partial class Master : Form
    {
        ...
        public void button3_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("1. Create a Sn0wbreeze IPSW for the desired iOS version and device." + Environment.NewLine + Environment.NewLine + "2. Open Eth3r and create a custom firmware." + Environment.NewLine + Environment.NewLine + "3. Use Sn0wbreeze to enter pwned DFU mode." + Environment.NewLine + Environment.NewLine + "4. Restore to the custom Eth3r IPSW located on your desktop using iTunes" + Environment.NewLine + Environment.NewLine + "5. After the restore goes through, use ipwndfu to install the alloc8 exploit." + Environment.NewLine + Environment.NewLine + "6. If you jailbroke your firmware, reboot after Cydia's Stashing to fix Cydia's crashing." + Environment.NewLine + Environment.NewLine + "Enjoy your custom firmware :)", "Instructions for Eth3r", MessageBoxButtons.OK);
        }
